...
public abstract class QDPort 
{
    ...
    public final static int penPat = 0 ;
    /** The fill pattern index */
    public final static int fillPat = 1 ;
    /** The background pattern index */
    public final static int backPat = 2 ;
	...
	switch (pat){
	case penPat: return ("Pen");
	case fillPat: return ("Fill");
	case backPat: return ("Background");
	} // switch
	...
	txSize=10;
	txFace = Font.PLAIN;
	txFont = QDFontManager.HelveticaID ;
	txOperation();
	linkMgr.resetText();
    } // txtNormal
    ...
    public abstract void setOrigin(Dimension d) ; 
    ...
    /** BitMap bottleneck procedure 
     * (Inside Macintosh: Imaging with Quickdraw p 3-136) 
     * This method is called for all bitmap drawing operations.
     * @param the source of the bitmap.
     * @exception QDException bitMap problem
     */
		 
    public abstract  void stdBits(QDBitSource bitSource) throws QDException ;
