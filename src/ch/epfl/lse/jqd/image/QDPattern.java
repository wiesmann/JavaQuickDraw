...
public class QDPattern 
{
    ...
    public final static QDPattern black = new QDPattern(1) ;
    /** standard Macintosh grayscale pattern (0%) */ 
    public final static QDPattern white = new QDPattern(0) ;
     /** standard Macintosh grayscale pattern (50%) */ 
    public final static QDPattern gray  = new QDPattern(0.5) ;
     /** standard Macintosh grayscale pattern (25%) */ 
    public final static QDPattern ltgray = new QDPattern(0.25) ;
     /** standard Macintosh grayscale pattern (75%) */ 
    public final static QDPattern dkgray = new QDPattern(0.75) ;
    ...
    public int read(QDInputStream stream) throws IOException, QDException {
	int total= 0 ;
	for (int i=0; i<4; i++) {
