...
public class QDInputStream extends DataInputStream {
    ...
    final public static int STYLE_SIZE = 1 ;
    final public static int POINT_SIZE = 4 ;
    final public static int RECT_SIZE = 8 ;
    final public static int SHORT_DIMENSION_SIZE = 2 ;
    final public static int OLD_COLOR_SIZE = 4; 
    final public static int FRAC_SIZE = 4 ;
    final public static int FIXED_SIZE = 4 ; 
    final public static int DV_SIZE = 2 ;
    final public static int DH_SIZE = 2 ; 
    final public static int MODE_SIZE = 2 ;
